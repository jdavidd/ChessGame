...
public class Server {
    ...
    private static ArrayList <utilizator> listaUtilizatori;
                    ...
                    //S-a facut o cere de login
                        case 2:
                        {
                            ...
                            if(resultConexiune>0)
                            {
                                ...
                                if(ok==true)
                                {listaUtilizatori.add(new utilizator(idUser,numeUser));
                        ...
                        case 4:
                        {
                            out.println("1;okokoko");
                                        for(int i=0;i<listaUtilizatori.size();++i)
                            System.out.println(listaUtilizatori.get(i).getID());
                        }
                        default:
                        {
                            break;
